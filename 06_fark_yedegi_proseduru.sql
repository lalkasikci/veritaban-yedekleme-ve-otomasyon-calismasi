...
CREATE OR ALTER PROCEDURE dbo.usp_FarkYedegiAl
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET @Dosya =
        N'C:\SQLBackup\BLM4522\BLM4522_OtomasyonProjesi_DIFF_' +
    ...
    BEGIN TRY
        ...
        VALUES
        (
            N'BLM4522_OtomasyonProjesi', N'FARK', @Dosya, 1,
    ...
    BEGIN CATCH
        ...
        VALUES
        (
            N'BLM4522_OtomasyonProjesi', N'FARK', @Dosya, 0,
