...
CREATE OR ALTER PROCEDURE dbo.usp_LogYedegiAl
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SET @Dosya =
        N'C:\SQLBackup\BLM4522\BLM4522_OtomasyonProjesi_LOG_' +
        CONVERT(CHAR(8), GETDATE(), 112) + N'_' +
        REPLACE(CONVERT(CHAR(8), GETDATE(), 108), ':', '') + N'.trn';

    BEGIN TRY
        SET @Sql =
            N'BACKUP LOG BLM4522_OtomasyonProjesi
        ...
        VALUES
        (
            N'BLM4522_OtomasyonProjesi', N'LOG', @Dosya, 1,
    ...
    BEGIN CATCH
        ...
        VALUES
        (
            N'BLM4522_OtomasyonProjesi', N'LOG', @Dosya, 0,
